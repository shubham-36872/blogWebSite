...
func (c *blogServiceClient) ReadPost(ctx context.Context, in *PostID, opts ...grpc.CallOption) (*Post, error) {
	out := new(Post)
...
func (UnimplementedBlogServiceServer) ReadPost(context.Context, *PostID) (*Post, error) {
